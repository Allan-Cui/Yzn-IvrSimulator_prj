...
//    			System.out.println(combobox02.getSelectedItem());
...
//    			}
    			...
    			if (radio09.isSelected()) {
    				String StartInputTimers = "true";
    			} else {
    				String StartInputTimers = "false";
    			}
    			if (radio10.isSelected()) {
    				String CancelIfQueue = "true";
    			} else {
    				String CancelIfQueue = "false";
    			}
    			...
    			txt = header + gram + footer;
    			System.out.println(txt);
    			JOptionPane.showMessageDialog(null, "Go!", "message", 2);
    		}
